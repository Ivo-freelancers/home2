/**handles:wp-polyfill,wp-i18n**/ ! function r(c, a, f) {
    function o(n, t) {
        if (!a[n]) {
            if (!c[n]) {
        ...
        y.prototype.getPluralForm = function(n, t) {
            ...
            return u || ("function" != typeof(i = (e = this.data[n][""])["Plural-Forms"] || e["plural-forms"] || e.plural_forms) && (r = function(n) {
                ...
                for (t = n.split(";"), e = 0; e < t.length; e++)
                    if (0 === (r = t[e].trim()).indexOf("plural=")) return r.substr(7)
            ...
            _ = function(n, t) {
                var e = new y({}),
                    r = function(n) {
                        ...
                        e.data[t] = x(x(x({}, m), e.data[t]), n), e.data[t][""] = x(x({}, m[""]), e.data[t][""])
                    },
                    i = function() {
