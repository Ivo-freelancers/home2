    ...
    */
    ...
    function handleAccordionBox() {
        $('[data-ohio-accordion]').each(function() {
            ...
            var iconOpened = 'ion-md-remove',
                iconClosed = 'ion-md-add';
    ...
    function centeredLogo() {
        ...
        headerNav.offset({
            left: siteBrand.offset().left - firstMenuItemsWidth + (parseInt(menuLinkPadding) / 2)
        });
        ...
        if (mousescrollSetting === true) {
            ...
            onePage.on('wheel mousewheel', function(e) {
                ...
                if ((currentItem == 0 && y > 0) || (currentItem == onePageItemsCount && y < 0)) {
                    $("html, body").animate({
                        scrollTop: onePage.offset().top + 'px'
                    });
                    e.preventDefault();
                }
    ...
    $(window).on('load', function() {
        ...
        var mobileResizeWidth = $(window).width(),
            mobileResizeHeight = $(window).height();
