! function(e) {
    ...
    function v(e, t, n, o) {
        ...
        for (; u--;)(a[i = t[u]] || (a[i] = [])).push([n, c]), e.addEventListener(i, c)
    }
    ...
    function s(e, t, n) {
        ...
        if (u)
            for (; c--;)
                if (i = u[o = t[c]])
                    for (a = i.length; a--;) i[a][0] === n && (e.removeEventListener(o, i[a][1]), i.splice(a, 1))
    }

    function l(e, t, n) {
        var o = function(e) {
            return new CustomEvent(e, m)
        }(t);
    ...
    function w() {
        s(document, c.move, n), s(document, c.cancel, y)
    }

    function b(e) {
        s(document, r.move, e.touchmove), s(document, r.cancel, e.touchend)
    }

    function T(e, t, n, o) {
        var i = n.pageX - t.pageX,
            a = n.pageY - t.pageY;
        i * i + a * a < u * u || function(e, t, n, o, i, a) {
    ...
    function S(e, t) {
        var n = t.target,
            o = t.event,
            i = t.timer;
        s(document, c.move, E), s(document, c.end, S), K(n, o, i, function() {
            setTimeout(function() {
                s(n, "click", h)
            }, 0)
        })
    ...
    function k(e, t) {
        var n = t.target,
            o = t.event,
            i = t.timer;
        X(e.changedTouches, o.identifier) && (function(e) {
            s(document, r.move, e.activeTouchmove), s(document, r.end, e.activeTouchend)
        }(t), K(n, o, i))
    }
    ...
    if (v(document, "mousedown", function(e) {
            ...
            }(e) || (v(document, c.move, n, e), v(document, c.cancel, y, e))
                ...
                var t = {
                    ...
                    n = {
                        ...
                        timer: new p(function(e) {
                            ...
                            })(t, n.touch, n.timeStamp), l(n.target, "move", t)
                        }),
                        touch: void 0,
                        timeStamp: e.timeStamp
                    };
                void 0 === e.identifier ? (v(e.target, "click", h), v(document, c.move, E, n), v(document, c.end, S, n)) : (n.activeTouchmove = function(e, t) {
                    ! function(e, t) {
                        var n = t.event,
                            o = t.timer,
                            i = Y(e, n);
                    ...
                    k(e, t)
                }, v(document, r.move, n.activeTouchmove, n), v(document, r.end, n.activeTouchend, n))
            }
        }), window.jQuery) {
